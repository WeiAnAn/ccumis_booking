...
<div class="row">
    ...
    <div class="col-md-8">
        <form action='{{URL("/admin/semester_class_update/$class->id")}}' method="post">
            {{csrf_field()}}
            ...
            <div class="form-group">
                ...
                @endif
                <input type="text" class="form-control" name="borrower" value="{{$class->borrower}}" required>
            </div>
...
<script>
    ...
    $('#startMin')[0].value = startTime[1];
    $('#endHour')[0].value = endTime[0];
    $('#endMin')[0].value = endTime[1];
</script>
@endsection